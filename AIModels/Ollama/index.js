...
//     let { clientId, conversationId, newConversation, message, config } = req.body || {};
//     let history = [];
//     if (!newConversation) {
...
//         //     //     ]);
//         //     // } else {
//         //         conversationId = activeConversation.get(conversationId);
...
//         // ---- Main Ollama Call ----
//         // console.log("sessssssssssssssssssssssssssssssssssssss ", sess.messages);
//         // console.log(history);
...
//                 if (isExternal) {
//                     res.send({ ok: true, role: 'model', text: resultText, conversationId, clientId, toolName: name });
//                 } else {
...
//             if (isExternal) {
//                 res.send({ ok: true, role: 'model', text, conversationId });
//             } else {
//                 sseManager.send(conversationId, 'message', { role: 'model', text, conversationId, clientId });
//                 return res.json({ ok: false, conversationId });
//             }
//         }
//     } catch (err) {
//         console.error(err);
